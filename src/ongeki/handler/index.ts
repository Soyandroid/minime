...
import getUserBoss from "./getUserBoss";
...
import getUserTechCount from "./getUserTechCount";
import getUserTradeItem from "./getUserTradeItem";
...
export default function ongeki(db: DataSource) {
  ...
  wrapper.rpc("/GetUserBossApi", getUserBoss);
  ...
  wrapper.rpc("/GetUserScenarioApi", getUserScenario);
  wrapper.rpc("/GetUserStoryApi", getUserStory);
  wrapper.rpc("/GetUserTechCountApi", getUserTechCount);
  wrapper.rpc("/GetUserTradeItemApi", getUserTradeItem);
