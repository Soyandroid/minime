...
import getUserFavoriteItem from "./getUserFavoriteItem";
...
import getUserRivalData from "./getUserRivalData";
import getUserRivalMusic from "./getUserRivalMusic";
...
export default function chunithm(db: DataSource) {
  ...
  wrapper.rpc("/GetUserFavoriteItemApi", getUserFavoriteItem);
  ...
  wrapper.rpc("/GetUserRivalDataApi", getUserRivalData);
  wrapper.rpc("/GetUserRivalMusicApi", getUserRivalMusic);
  wrapper.rpc("/GetUserTeamApi", getUserTeam);
